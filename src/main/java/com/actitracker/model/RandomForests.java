...
public class RandomForests {
  ...
  public Double createModel(JavaSparkContext sc) {
    ...
    // create model
    final RandomForestModel model = RandomForest.trainClassifier(trainingData, numClasses, categoricalFeaturesInfo, numTrees, featureSubsetStrategy, impurity, maxDepth, maxBins, 12345);
